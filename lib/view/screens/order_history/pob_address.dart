...
class PobAddress extends StatefulWidget {
  final int pob;
  const PobAddress({Key key, this.pob}) : super(key: key);

  @override
  State<PobAddress> createState() => _PobAddressState();
}

class _PobAddressState extends State<PobAddress> {
  bool _loading = false;
  ...
  loadPoxList() async {
    ...
    var res = await http.get(Uri.parse(AppConstants.baseUri+AppConstants.getCustomerAddressUri+'${widget.pob}'));
