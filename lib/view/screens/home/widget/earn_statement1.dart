...
class EarnStatementWidget1 extends StatelessWidget {
  final String profile;
  final String mails;
  final String phone,email;

  const EarnStatementWidget1({Key key, this.profile, this.mails, this.phone, this.email,}) : super(key: key);
          ...
          Container(height: 120,
            ...
            child: Stack(children: [Positioned.fill(
              child: Align(alignment: Alignment.topLeft,
                  child: Container(width: 250, height : 100, decoration: BoxDecoration(
