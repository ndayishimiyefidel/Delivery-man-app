...
class _HomeScreen1State extends State<HomeScreen1> {
  ...
  Future<void> totalMails() async {
    final response = await http.get(Uri.parse(AppConstants.baseUri+AppConstants.getCustomerMailUri+'$userId'));
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            EarnStatementWidget1(profile:  '$_userName',mails: '$rowCount',email: '$_userEmail',),
